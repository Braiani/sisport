...
@section('content')
    <div style="background-size:cover; background-image: url('https://source.unsplash.com/collection/{{ Voyager::setting('admin.bg_image', '2128442') }}/1920x1080/'); background-position: center center;position:absolute; top:0; left:0; width:100%; height:300px;"></div>
